...
const LoadingState = () => (
    <div className="flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">Sipariş detayları yükleniyor...</p>
    </div>
);
            ...
            <DialogContent className="sm:max-w-[600px] lg:max-w-[800px] bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
                {loading || !orderDetail ? (
                    ...
                    try {
                                                ...
                                                <CardContent className="p-5">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm font-semibold text-violet-900 dark:text-violet-100">{header.TarihText}</p>
                                                        </div>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                                ...
                                                <CardContent className="p-5">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm font-semibold text-blue-900 dark:text-blue-100">{header.EmployeeName}</p>
                                                        </div>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                                ...
                                                <CardContent className="p-5">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm font-semibold text-emerald-900 dark:text-emerald-100">{header.GuestNumber} Kişi</p>
                                                        </div>
                                                    </div>
                                                </CardContent>
                                            </Card>
                        ...
                        console.error('Order detail parse error:', error);
                        return <ErrorState />;
                    }
                })()}
            </DialogContent>
