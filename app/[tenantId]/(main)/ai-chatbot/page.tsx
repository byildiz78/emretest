...
const AIChatbotPage = () => {
                    ...
                    <thead>
                        <tr>
                            {headers.map((header, index) => (
                                <th
                                    key={index}
                                    className="border px-4 py-2 bg-gray-50 text-left text-sm font-medium text-gray-500"
                                >
                                    {header}
                                </th>
                            ))}
    ...
    return (
        <div className="w-full min-h-screen bg-gradient-to-b from-white to-gray-50/50 px-4 py-6">
            <motion.div
            ...
            >
                ...
                <motion.div 
                    ...
                    className="w-full bg-white rounded-2xl shadow-sm border"
                >
                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6 scroll-smooth">
                                            ...
                                            : Array.isArray(message.content) 
                                                ...
                                                : typeof message.content === 'string' 
                                                    ? <ReactMarkdown 
                                                        components={{
                                                            pre: ({node, ...props}) => (
                                                                <pre className="bg-gray-100 p-3 rounded-md my-2 overflow-x-auto" {...props} />
                                                            ),
                                                            code: ({node, ...props}) => (
                            ...
                            {isLoading && (
                                ...
                                >
                                    ...
                                    <div className="rounded-2xl rounded-bl-sm p-4 border bg-white">
                        ...
                        <div className="p-4 border-t bg-white rounded-b-2xl">
                            <div className="flex gap-2 items-center">
                                <input
                                    ...
                                    className="flex-1 p-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                                />
                                <button
                                    onClick={handleSend}
                                    disabled={!input.trim() || isLoading}
                                    className="p-3 rounded-xl bg-gradient-to-r from-primary to-primary/90 hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all text-white"
                                >
